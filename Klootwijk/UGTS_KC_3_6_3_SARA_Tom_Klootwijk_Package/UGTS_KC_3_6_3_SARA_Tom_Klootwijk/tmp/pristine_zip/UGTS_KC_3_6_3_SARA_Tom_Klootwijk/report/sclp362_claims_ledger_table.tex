...
\begin{longtable}{p{0.08\linewidth} p{0.28\linewidth} p{0.11\linewidth} p{0.47\linewidth}}
\caption{SCLP 3.6.2 claims ledger.}\label{tab:sclp-claims}\\
\toprule
\textbf{ID} & \textbf{Source claim or motif} & \textbf{Disposition} & \textbf{Technical boundary}\\
\midrule
\endfirsthead
\toprule
\textbf{ID} & \textbf{Source claim or motif} & \textbf{Disposition} & \textbf{Technical boundary}\\
...
C362-08 & All forces automatically scale by e\textasciicircum{}-rho & CORRECTED & Coordinate covectors transform by the inverse Jacobian; physical force laws remain separately typed.\\
...
C362-17 & Log packing stores infinite detail in finite memory & REJECT & The declared profile contains exactly 2\textasciicircum{}64 keys and finite grammar/state budgets.\\

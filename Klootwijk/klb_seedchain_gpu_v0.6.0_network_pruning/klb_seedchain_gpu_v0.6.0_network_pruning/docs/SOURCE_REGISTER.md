...
| `klb_cuda_arch_test_v0.1.0.zip` | `fdc90da89d1ffe5015d046ed8a16d804881237f89574c431d3525e4bda8d5276` | Prior KLB37 base implementation used as the code substrate for version 0.2.0 and retained in version 0.3.0 |
...
- CelesTrak GP/OMM query documentation: `https://celestrak.org/NORAD/documentation/gp-data-formats.php`
- CelesTrak usage policy: `https://celestrak.org/usage-policy.php`
- CelesTrak GPS Operational CSV query: `https://celestrak.org/NORAD/elements/gp.php?GROUP=GPS-OPS&FORMAT=CSV`

These links are not bundled data or third-party code dependencies.

## Version 0.6 external-data register

| Source | Local artifact | Role |
|---|---|---|
| CelesTrak GPS-OPS OMM CSV query | `data/network/source/gps_ops_2026-08-16_omm.csv` | navigation/MEO seed family |
| CelesTrak TDRSS TLE group query | `data/network/source/tdrss_mixed_2026-07-29.tle` | mixed LEO/GEO/HEO seed family |
| IGS precise orbit products | not redistributed | optional external SP3 accuracy challenge |

Exact hashes and derivations are recorded in
`data/network/source/source_manifest.json`. The 16-station CSV is package-authored
benchmark policy input and is not a real network registry.
